def main():
    """
    Entry point for day 18, part 1
    :return: Exit code
    """
    # space_size, byte_sim = 71, 1024

    # byte_positions = read_input('input_p.txt')
    maze, start_tile, end_tile = read_input_help('input_p.txt')
