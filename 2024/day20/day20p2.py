def main():
    ...
    # print_map(track)
    print('Number of shortcuts: ' + str(len(list(set(shortcuts)))))
...
def find_shortcuts(track, path):
    ...
    for node in path:
        ...
        for cheat_node in path:
            if calculate_heuristic(node_pos, cheat_node[0]) <= cheat_range:
                cheat_successors.append(cheat_node[0])
        ...
        for successor in cheat_successors:
            ...
            for path_node in path:
                ...
                if successor == path_node[0] and (
                        (path_node[1] - node_dis) - calculate_heuristic(path_node[0], node_pos) >= time_save):
